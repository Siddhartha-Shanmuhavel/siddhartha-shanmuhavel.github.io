...
(function(html) {
    ...
    * ------------------------------------------------------ */
    const ssServicesList = function() {

        const $allItems = document.querySelectorAll('.services-list__item');

        if ($allItems.length === 0) return;

        const $allPanels = Array.from($allItems).map(item => item.querySelector('.services-list__item-body'));
        ...
        $allItems.forEach(item => {
            const header = item.querySelector('.services-list__item-header');

            header.addEventListener('click', function(e) {
                e.preventDefault();

                const $curPanel = item.querySelector('.services-list__item-body');
                ...
                if (!item.classList.contains('is-active')) {
                    ...
                    // Show current panel and add is-active class
